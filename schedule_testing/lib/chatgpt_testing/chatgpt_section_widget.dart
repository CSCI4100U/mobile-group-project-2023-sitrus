...
class _SectionListState extends State<SectionList> {
  ...
  Widget build(BuildContext context) {
    List<ClassContainerList> sectionList = [
      ClassContainerList(),
      ClassContainerList(),
      // Add more ClassContainerList widgets as needed
    ];
...
class _ClassContainerListState extends State<ClassContainerList> {
  List<ContainerItem> classContainers = [ContainerItem(name: 'Lecture 1')];

  void addClassContainer() {
    classContainers.add(ContainerItem(name: 'Lecture ${classContainers.length + 1}'));
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text('Section ', style: TextStyle(fontSize: 24.0),),
        ListView.builder(
          shrinkWrap: true,
...
class ContainerItem extends StatefulWidget {
  final String name;
  ContainerItem({required this.name});
